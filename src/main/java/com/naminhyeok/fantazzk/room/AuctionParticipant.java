...
@Embeddable
@EqualsAndHashCode
final class AuctionParticipant implements GameParticipant, ValueObject {
    ...
    AuctionParticipant(TeamLeaderId teamLeaderId, String nickname, int remainingBudget) {
    ...
    AuctionParticipant withRemainingBudget(int remainingBudget) {
