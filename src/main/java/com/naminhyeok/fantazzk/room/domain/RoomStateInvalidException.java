...
public class RoomStateInvalidException extends InvalidDomainStateException {
    ...
    public static RoomStateInvalidException auctionWinnerBudgetExceeded(TeamLeaderId winnerId, Integer remainingBudget, int amount) {
