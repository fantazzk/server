...
(
    template_player_id UUID PRIMARY KEY,
...
(
    room_player_id UUID PRIMARY KEY,
...
(
    room_team_leader_id UUID PRIMARY KEY,
...
(
    room_team_member_id UUID PRIMARY KEY,
