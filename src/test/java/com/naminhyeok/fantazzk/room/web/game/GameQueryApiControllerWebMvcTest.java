...
class GameQueryApiControllerWebMvcTest {
    ...
    void get은_started_game_snapshot을_반환한다() throws Exception {
        given(gameQueryApi.get(UUID.fromString(RoomApiTestFixtures.GAME_ID)))
    ...
    void get은_game이_없으면_404를_반환한다() throws Exception {
        given(gameQueryApi.get(UUID.fromString(RoomApiTestFixtures.GAME_ID))).willThrow(coreException(HttpStatus.NOT_FOUND, "GAME_NOT_FOUND"));
